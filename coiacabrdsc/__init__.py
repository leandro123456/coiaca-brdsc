"""Python library for interacting with Coiaca devices."""
import asyncio
import aiohttp


__author__ = "Leandro Guzman, Coiaca Inc <help@coiaca.com>"


class Client:
    """API wrapper for Coiaca Alarm Panels."""
    ...
    async def put_settings(
        ...
        """Sync settings to the Coiaca device."""
